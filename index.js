...
//------------------games-variable-----------------
let enimies = ["Skeleton", "Zombie", "Worrior", "Assassin"];
    ...
    while (enemyHealth > 0) {
        ...
        if (options.ans === "1. Attack") {
            ...
            if (numHealthPotion > 0) {
                ...
                console.log(chalk.bold.red(`you have no health potion left.defeat enemy to get a chance to get health potion`));
            }
        }
